...
@ToString
@Table(name = "LOAN")
@NamedStoredProcedureQueries(@NamedStoredProcedureQuery(name = "ListLoan.getLoanList", procedureName = "pck_loan.getLoanList", resultClasses = ListLoan.class, parameters = {
