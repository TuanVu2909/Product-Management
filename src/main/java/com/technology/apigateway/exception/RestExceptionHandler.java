...
import com.technology.apigateway.constant.ErrorInfo;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleAllExceptionImpl(Exception ex, HttpHeaders headers, HttpStatus status,
		...
		try {
			...
			ErrorInfo errorInfo = new ErrorInfo(String.valueOf(HttpStatus.BAD_REQUEST.value()),
					status.getReasonPhrase(), e.getStatus(), e.getMessage(),
		...
		ErrorInfo errorInfo = new ErrorInfo(String.valueOf(status.value()), status.getReasonPhrase(), null,
				ex.getMessage(),
				((ServletWebRequest) request).getRequest().getRequestURL().toString());
		return new ResponseEntity<Object>(errorInfo, status);
	}
